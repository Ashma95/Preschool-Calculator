...
class ViewController: UIViewController {
    ...
    func displayLayout(){
        ...
        //background
        self.bkg.frame = CGRect(x: 0, y: 0, width : self.W, height: self.H)
        ...
        //question label
         self.question.frame = CGRect(origin: CGPoint(x: self.W * 0.2, y: self.H * 0.4), size: CGSize(width: self.W * 0.8, height: self.H * 0.1))
        
        //apples
         self.apple1.frame = CGRect(x: self.W * 0.20, y: self.H * 0.15, width: self.W * 0.14, height: self.H * 0.07)
         self.apple2.frame = CGRect(x: self.W * 0.25, y: self.H * 0.12, width: self.W * 0.14, height: self.H * 0.07)
         self.apple3.frame = CGRect(x: self.W * 0.35, y: self.H * 0.12, width: self.W * 0.14, height: self.H * 0.07)
         self.apple4.frame = CGRect(x: self.W * 0.45, y: self.H * 0.12, width: self.W * 0.14, height: self.H * 0.07)
         self.apple5.frame = CGRect(x: self.W * 0.55, y: self.H * 0.12, width: self.W * 0.14, height: self.H * 0.07)
         self.apple6.frame = CGRect(x: self.W * 0.3, y: self.H * 0.16, width: self.W * 0.14, height: self.H * 0.07)
         self.apple7.frame = CGRect(x: self.W * 0.4, y: self.H * 0.16, width: self.W * 0.14, height: self.H * 0.07)
         self.apple8.frame = CGRect(x: self.W * 0.5, y: self.H * 0.16, width: self.W * 0.14, height: self.H * 0.07)
         self.apple9.frame = CGRect(x: self.W * 0.6, y: self.H * 0.16, width: self.W * 0.14, height: self.H * 0.07)
        
        //plate
        self.plate.frame = CGRect(x: self.W * 0.08, y: self.H * 0.08, width: self.W * 0.8, height: self.H * 0.22)
        
        //playbutton
        self.playbutton.frame = CGRect(x: self.W * 0.36, y: self.H * 0.55, width: self.W * 0.27, height: self.H * 0.15)
    ...
    func appleAnimation(){
        UIView.animate(withDuration: 4.0, delay: 0.5, usingSpringWithDamping: 2.0, initialSpringVelocity: 10, options: [], animations:{
